...
const Index = () => {
  ...
  return (
    <header>
      <h3 className='logo'>Mathy</h3>

      <div>
        {theme === 'light-theme' ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className='toggleTheme' onClick={()=> toggleTheme()} >
          <path
        ...
        </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"  className='toggleTheme' onClick={()=> toggleTheme()}>
          <path
